...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>DG</b>A</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>DG</b>Ambassadors</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="{{ url('/') }}">Digital Ambassadors</a>.</strong> All rights reserved.
  </footer>
