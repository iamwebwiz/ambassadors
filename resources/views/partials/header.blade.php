                    ...
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item"> <a id="homepage" class="nav-link" href="{{ url('/#home') }}">HOME <span class="sr-only">(current)</span></a> </li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/#features') }}">FEATURES</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/#gallery') }}">GALLERY</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/#pricing') }}">PRICING</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/#contact') }}">CONTACT</a> </li>
                                <li class="nav-item"> <a id="login" class="nav-link" href="{{ url('login') }}">LOGIN</a> </li>
                                <li class="nav-item"> <a id="register" class="nav-link" href="{{ url('register') }}">REGISTER</a> </li>
